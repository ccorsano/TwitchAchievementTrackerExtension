...
import { ActiveConfig, type ExtensionConfiguration, type PlayerInfoCard, type SupportedLanguage, type TitleInfo } from "../../common/EBSTypes";
import XBoxLiveLogo from '../../../assets/XBox_Live_logo.svg';
import SteamLogo from '../../../assets/Steam_icon_logo.svg';

export let extensionConfig: ExtensionConfiguration | null
